...
export function Gamification({ view }: GamificationProps) {
  const leaderboard = [
    { rank: 1, name: "Trần Văn B", role: "Design", points: 520, change: 2, badges: ["🏆", "🎯", "⚡"] },
    { rank: 2, name: "Nguyễn Văn A", role: "Content", points: 450, change: 0, badges: ["🏆", "🎯"] },
    { rank: 3, name: "Lê Thị C", role: "Digital", points: 380, change: -1, badges: ["🎯"] },
    { rank: 4, name: "Phạm Văn D", role: "Video", points: 320, change: 1, badges: ["🎬"] },
    { rank: 5, name: "Hoàng Thị E", role: "Content", points: 280, change: 0, badges: ["📝"] },
    { rank: 6, name: "Đặng Văn F", role: "Design", points: 250, change: -2, badges: ["🎨"] },
  ];
