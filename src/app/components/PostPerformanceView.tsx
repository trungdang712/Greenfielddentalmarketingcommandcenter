  ...
  const postsData = [
    {
      ...
      platform: "Facebook",
      type: "Video",
      title: "Before/After niềng răng Invisalign - Transformation kỳ diệu",
      thumbnail: "📹",
      ...
      videoViews: 15230,
      avgWatchTime: "2:45",
      caption: "🦷 ✨ Chuyển biến nụ cười chỉ trong 8 tháng! Từ răng móm đến nụ cười tự tin rạng rỡ với công nghệ niềng răng Invisalign tại Greenfield Dental. #NiengRang #Invisalign #NuCuoiHoanHao",
      ...
      topComments: [
        { user: "Nguyễn Thị A", text: "Đẹp quá! Mình cũng đang muốn niềng răng", sentiment: "positive", likes: 45 },
        { user: "Trần Văn B", text: "Có phải đau lắm không?", sentiment: "neutral", likes: 23 },
        { user: "Lê Thị C", text: "Giá bao nhiêu vậy shop?", sentiment: "neutral", likes: 18 },
      ],
      hourlyEngagement: [
      ...
      demographics: {
        ...
        topCities: [
          ...
          { city: "Hà Nội", percentage: 22 },
          { city: "Đà Nẵng", percentage: 12 },
          { city: "Khác", percentage: 8 },
        ],
      },
    },
    {
      ...
      platform: "Instagram",
      type: "Carousel",
      title: "5 lý do nên chọn Implant thay vì cầu răng",
      thumbnail: "📸",
      ...
      clicks: 215,
      ctr: 1.71,
      caption: "💡 Bạn đang phân vân giữa Implant và cầu răng? Hãy xem 5 lý do tại sao Implant là lựa chọn vượt trội! Swipe để khám phá ➡️",
      ...
      topComments: [
        { user: "Mai Phương", text: "Thông tin rất hữu ích, cảm ơn!", sentiment: "positive", likes: 38 },
        { user: "Hoàng Anh", text: "Implant có bền không?", sentiment: "neutral", likes: 19 },
        { user: "Thu Hà", text: "Giá implant bao nhiêu?", sentiment: "neutral", likes: 15 },
      ],
      hourlyEngagement: [
      ...
      demographics: {
        ...
        topCities: [
          ...
          { city: "Hà Nội", percentage: 20 },
          { city: "Đà Nẵng", percentage: 10 },
          { city: "Khác", percentage: 8 },
        ],
      },
    },
    {
      ...
      platform: "Zalo",
      type: "Image",
      title: "Flash Sale - Tẩy trắng răng Zoom giảm 30%",
      thumbnail: "🎨",
      ...
      clicks: 178,
      ctr: 1.99,
      caption: "⚡ FLASH SALE 48H ⚡ Tẩy trắng răng Zoom - Trắng sáng chỉ trong 1 giờ! Giảm ngay 30% - Chỉ từ 3.5 triệu. Book ngay!",
      ...
      topComments: [
        { user: "Lan Anh", text: "Đặt lịch luôn! Giá quá tốt", sentiment: "positive", likes: 28 },
        { user: "Minh Tuấn", text: "Có bền không?", sentiment: "neutral", likes: 12 },
        { user: "Hương Giang", text: "Đã book rồi, hẹn gặp", sentiment: "positive", likes: 15 },
      ],
      hourlyEngagement: [
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="relative flex-1 max-w-sm">
          ...
          <Input placeholder="Tìm kiếm post..." className="pl-10" />
        </div>
