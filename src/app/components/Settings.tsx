  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Quản lý tài khoản, team, và cấu hình hệ thống</p>
      </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  defaultValue="Marketing professional với 8+ năm kinh nghiệm trong ngành dental & healthcare. Chuyên về digital marketing, content strategy và brand development."
                />
              </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  id="address"
                  rows={2}
                  defaultValue="123 Nguyễn Văn Linh, Quận 7, TP. Hồ Chí Minh, Việt Nam"
                />
              </div>
